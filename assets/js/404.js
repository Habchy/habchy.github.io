...
(function () {
  ...
  try {
    ...
    styleEl.textContent =
      '@keyframes nfMarqueeLeft  { from { transform: translateX(0); } to { transform: translateX(-' + totalShift + 'px); } }' +
      '@keyframes nfMarqueeRight { from { transform: translateX(-' + totalShift + 'px); } to { transform: translateX(0); } }';
